...
function loadProfileIntoState(id) {
  ...
  // Deep merge data
  STATE.data = {
    personal: { firstName:'', lastName:'', professionalTitle:'', email:'', phone:'', location:'', website:'', linkedin:'', github:'', photo:'', dob:'', maritalStatus:'', correspondenceAddress:'', permanentAddress:'', ...profile.data.personal },
