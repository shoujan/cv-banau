...
function getResumeCSS() {
  ...
  return `
    ...
    /* Nepali Style: keep print/PDF output identical to the preview structure */
    .resume-nepali { width: 794px; min-height: 1123px; padding: 42px 48px 56px; background: #fff; color: #111820; font-family: Arial, Helvetica, sans-serif; line-height: 1.45; }
    .resume-nepali .np-header { display: flex; justify-content: space-between; align-items: flex-start; gap: 24px; margin-bottom: 16px; }
    .resume-nepali .np-name { padding-top: 8px; font-size: 25px; font-weight: 800; letter-spacing: .1px; text-transform: uppercase; }
    .resume-nepali .np-title { margin-top: 4px; color: #536170; font-size: 13px; }
    .resume-nepali .np-photo { width: 112px; height: 132px; object-fit: cover; border: 1px solid #d2d8de; background: #eef3f8; flex: 0 0 auto; }
    .resume-nepali .np-photo-placeholder { display: grid; place-items: center; color: #2f6fba; font-size: 25px; font-weight: 800; }
    .resume-nepali .np-section-title { margin-top: 18px; padding: 3px 8px; background: #eef0f2; border-bottom: 1px solid #d5d9dd; font-size: 16px; font-weight: 800; text-decoration: underline; }
    .resume-nepali .np-details { display: grid; gap: 7px; padding: 10px 2px 2px; font-size: 13px; }
    .resume-nepali .np-paragraph { padding: 10px 2px 0; font-size: 13px; white-space: pre-line; }
    .resume-nepali .np-table-wrap { overflow: visible; margin-top: 10px; }
    .resume-nepali .np-education { width: 100%; border-collapse: collapse; table-layout: fixed; font-size: 12px; }
    .resume-nepali .np-education th, .resume-nepali .np-education td { border: 1px solid #424951; padding: 7px 6px; vertical-align: top; word-wrap: break-word; }
    .resume-nepali .np-education th { background: #f8f9fa; font-size: 12px; line-height: 1.2; }
    .resume-nepali .np-education th:nth-child(1) { width: 24%; } .resume-nepali .np-education th:nth-child(2) { width: 29%; } .resume-nepali .np-education th:nth-child(3) { width: 16%; } .resume-nepali .np-education th:nth-child(4) { width: 17%; } .resume-nepali .np-education th:nth-child(5) { width: 14%; }
    .resume-nepali .np-empty-cell { text-align: center; color: #7c8791; padding: 16px !important; }
    .resume-nepali .np-skills { margin: 10px 0 0 24px; padding-left: 18px; font-size: 13px; }
    .resume-nepali .np-skills li { padding: 2px 0; }
    .resume-nepali .np-experience { padding: 10px 2px 0; font-size: 13px; }
    .resume-nepali .np-experience-item { margin-bottom: 12px; }
    .resume-nepali .np-experience-item span { float: right; color: #5d6873; font-size: 12px; }
    .resume-nepali .np-experience-item p { margin: 3px 0 0; white-space: pre-line; }
    .resume-nepali .np-empty-note { padding: 8px 0; color: #6e7b87; font-style: italic; }
    .resume-nepali .np-projects { padding: 10px 2px 0; font-size: 13px; }
    .resume-nepali .np-project-item { padding: 0 0 10px; margin-bottom: 10px; border-bottom: 1px solid #e0e4e8; }
    .resume-nepali .np-project-title { font-weight: 800; }
    .resume-nepali .np-project-subtitle { margin-top: 2px; color: #526270; font-weight: 600; }
    .resume-nepali .np-project-tech { margin-top: 2px; color: #6b7782; font-size: 12px; }
    .resume-nepali .np-project-item p { margin: 4px 0 0; white-space: pre-line; }
  `;
}
